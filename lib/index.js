...
internals.compileModel = (name, schema) => {
  ...
  const table = new Table(tableName, schema, serializer, internals.loadDocClient(), log, schema.optionCreateTable);
  ...
  Model.optionCreateTable = _.bind(table.optionCreateTable, table);
